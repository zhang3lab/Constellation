...
from server.deepseek_full_model_ref import DeepseekFullModelRefBase
...
def run_sparse_layer(
    ...
    *,
    ...
    attn_shared = ref.run_attention_shared_segment(
        hidden_in,
        layer_id,
        position_ids=position_ids,
        attention_mask=attention_mask,
    ...
    attn_shared = _normalize_attention_shared_result(
        attn_shared,
        hidden_in.shape,
        f"sparse_layer{layer_id}.attention_shared",
    )

    post_attn_hidden = hidden_in + attn_shared.attention_output
    post_attn_hidden = as_f32_1d(
        post_attn_hidden,
    ...
    ffn_total = attn_shared.shared_expert_output + routed_out
    ...
    result = {
        ...
        "layer_type": "sparse",
        "output": output,
        "attention_output": attn_shared.attention_output,
        "shared_expert_output": attn_shared.shared_expert_output,
        "routed_output": routed_out,
    }
    if return_aux:
        result["attention_shared_aux"] = attn_shared.aux
        result["routed_aux"] = {
